...
@Init
public class InvalidRequestExceptionExecutor implements ExceptionExecutor<RouterExceptionContext> {
    private final IOStore ioStore;

    public InvalidRequestExceptionExecutor(IOStore ioStore) {
    ...
    public void execute(RouterExceptionContext context, Throwable throwable) {
        ...
        RouterExceptionSupport.respond(ioStore, context, 400, "Bad Request");
    }
}
