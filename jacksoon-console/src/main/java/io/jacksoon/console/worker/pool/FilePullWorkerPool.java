...
public class FilePullWorkerPool {
    ...
    public FilePullWorkerPool(MetricFileOffsetRepository metricFileOffsetRepository, ObjectMapper objectMapper, ProduceQueue produceQueue, ExecutorService filePullWorker) {
